...
const Settings: React.FC = () => {
  ...
  const handleRemoveStamp = () => {
     if(confirm('직인 이미지를 삭제하시겠습니까?')) {
        setInfo(prev => ({ ...prev, stampImage: '' }));
     }
  };
    ...
    return (
      <div className="flex items-center justify-center min-h-[60vh]">
        <div className="bg-white p-8 rounded-2xl shadow-xl border border-slate-200 w-full max-w-md text-center">
          ...
          <p className="mt-6 text-xs text-slate-400">PIN 번호를 입력해주세요.</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-8 pb-10 animate-fadeIn">
      ...
      <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-200">
        <h3 className="text-lg font-bold mb-4">자사 정보</h3>
        <div className="space-y-4">
          ...
          <div className="pt-4 border-t">
            ...
            <div className="flex items-center space-x-4">
                ...
                <button onClick={triggerFileInput} className="px-3 py-1.5 border rounded text-sm">파일 선택</button>
      ...
      <button onClick={handleSave} className="w-full py-4 bg-slate-800 text-white rounded-xl hover:bg-slate-900 font-bold text-lg shadow-lg flex justify-center items-center">
